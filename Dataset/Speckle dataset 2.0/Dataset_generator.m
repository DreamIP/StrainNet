...
addpath(genpath('path to reference speckles'));
...
for img = 1:363
    ...
    disp_y(:,SubsetSize-1:SubsetSize) = 0;   
     ...
     % Data labels
     name_ref = sprintf('Train_Data/Ref%03d_%02d.csv',img,l); % Test_Data
     name_def = sprintf('Train_Data/Def%03d_%02d.csv',img,l); % Test_Data
     name_dispx = sprintf('Train_Data/Dispx%03d_%02d.csv',img,l); % Test_Data
     name_dispy = sprintf('Train_Data/Dispy%03d_%02d.csv',img,l); % Test_Data
